...
cd /tmp/
wget -c https://artifacts.assassinate-you.net/artifactory/AppImageKit/travis-2054/appimagetool-x86_64.AppImage # https://github.com/AppImage/AppImageKit/pull/937#issuecomment-474494480
