...
cd /tmp/
wget -c https://artifacts.assassinate-you.net/artifactory/AppImageKit/travis-2009/appimagetool-x86_64.AppImage # https://github.com/probonopd/linuxdeployqt/issues/355
