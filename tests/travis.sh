...
sed -i -e 's|.*widget.selectComponent.*|widget.selectComponent("qt.qt5.5100.gcc_64");\nwidget.selectComponent("qt.qt5.5100.qtwebengine.gcc_64");|g' qt-installer-noninteractive.qs
